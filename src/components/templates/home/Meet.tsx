                  ...
                  <div className="geodir-category-img fl-wrap  agent_card">
                    <a
                      ...
                      <ul className="list-single-opt_header_cat">
                        <li>
                          <span className="cat-opt color-bg">4 listings</span>
                        </li>
                      </ul>
                    </a>
                ...
                <article className="geodir-category-listing fl-wrap">
                  <div className="geodir-category-img fl-wrap  agent_card">
                    <a
                      ...
                      <ul className="list-single-opt_header_cat">
                        <li>
                          <span className="cat-opt color-bg">6 listings</span>
                        </li>
                      </ul>
                    </a>
                    <div className="agent-card-social fl-wrap">
                ...
                <article className="geodir-category-listing fl-wrap">
                  <div className="geodir-category-img fl-wrap  agent_card">
                    <a
                      ...
                      <ul className="list-single-opt_header_cat">
                        <li>
                          <span className="cat-opt color-bg">23 listings</span>
                        </li>
                      </ul>
                    </a>
                    <div className="agent-card-social fl-wrap">
                  ...
                  <div className="geodir-category-content fl-wrap">
                    ...
                    <div className="agent_card-title fl-wrap">
                      <h4>
                        <a href="agent-single.html">Bill Trust</a>
                      </h4>
                      <h5>
                        <a href="agency-single.html">Your Sweet Home agency</a>
                      </h5>
                    </div>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <article className="geodir-category-listing fl-wrap">
                  <div className="geodir-category-img fl-wrap  agent_card">
                    <a
                      ...
                      <ul className="list-single-opt_header_cat">
                        <li>
                          <span className="cat-opt color-bg">12 listings</span>
                        </li>
                      </ul>
                    </a>
                    <div className="agent-card-social fl-wrap">
